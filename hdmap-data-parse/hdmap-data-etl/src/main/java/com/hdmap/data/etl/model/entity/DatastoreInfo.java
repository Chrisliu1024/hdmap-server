...
/**
 * 数据存储信息
 * @TableName datastore_info
 */
@TableName(value ="datastore_info", autoResultMap = true)
@Data
public class DatastoreInfo implements Serializable {
    ...
    /**
     * 类型：-1-unknow，0-postgis，1-csv，2-geojson，3-shapefile，4-mysql，5-geopackage，6-mongodb，7-kml，8-wfs
     */
    private DatastoreTypeEnum type;
    ...
    public boolean equals(Object that) {
        ...
        DatastoreInfo other = (DatastoreInfo) that;
