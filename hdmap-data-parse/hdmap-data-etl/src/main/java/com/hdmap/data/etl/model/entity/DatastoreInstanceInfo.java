...
/**
 * 
 * @TableName datastore_instance_info
 */
@TableName(value ="datastore_instance_info")
@Data
public class DatastoreInstanceInfo implements Serializable {
    /**
     * 主键ID
     */
    @TableId
    ...
    public boolean equals(Object that) {
        ...
        DatastoreInstanceInfo other = (DatastoreInstanceInfo) that;
