...
@SpringBootTest(classes = {MinFilter.class})
public class MinFilterTest extends CommonTest {

    @Before
    public void contextLoads() {
        //注册函数
        AviatorEvaluator.addFunction(new MinFilter());
    }
    @Test
    public void test() throws ParseException {
        ...
        Object result = AviatorEvaluator.execute("minFilter(features, 'age')", env);
